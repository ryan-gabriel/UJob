...
public class RegisterMahasiswa extends javax.swing.JFrame {
    ...
    private void initUI() {
        setTitle("UPI Job - Register Mahasiswa");
    ...
    private JPanel createRegisterPanel() {
        ...
        JLabel welcome = new JLabel("WELCOME SOBAT UPI", SwingConstants.CENTER);
        ...
        addLabeledField(panel, "Nama Lengkap", fullName, y++, gbc);

        JTextField email = new JTextField();
        addLabeledField(panel, "Email UPI", email, y++, gbc);

        JTextField nim = new JTextField();
        addLabeledField(panel, "NIM (Khusus Mahasiswa UPI)", nim, y++, gbc);
        ...
        // Register button
        JButton btn = new JButton("REGISTER MAHASISWA");
        ...
        btn.addActionListener(e -> {
            String nama = fullName.getText();
            String emailAddress = email.getText();
            String nimValue = nim.getText();
            String passwordValue = new String(pwdField.getPassword());

            // Automatically set role to "Mahasiswa"
            String roleValue = "Mahasiswa";
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new RegisterMahasiswa().setVisible(true));
    }
}
